    ...
    public partial class FileManagerWindow : Form
    {
        ...
        private void UpdateSearchList()
        {
            ...
            if (Directory.Exists(dest_folder))
            {
                ...
                TotalFolders.Text = "Cartelle totali: " + folder_num;
                TotalSize.Text = "Dimensioni: " + tot_size;
            }
        }
            ...
            foreach (string folder in Directory.GetDirectories(dest_folder))
            {
                foreach (string file_path in Directory.GetFiles(folder))
                {
                    ...
                    if (!file.StartsWith("."))
                    {
                        ...
                        {
                            foreach (string argument in SearchInput.Text.Split(" "))
                            {
                                if (file.ToLower().Contains(argument.ToLower()))
                                {
                                    containseverything = true;
                                }
                                else
                        ...
                        {
                            //solo se sono presenti le parole di ricerca
                            //aggiorna tutto (come metodo UpdateList)
